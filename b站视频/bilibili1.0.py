...
for k in range(2,page+2):
    baseurl = f"https://search.bilibili.com/all?vt=71344461&keyword=%E5%BC%80%E8%BD%A6+%E7%AC%AC%E4%B8%80%E8%A7%86%E8%A7%92&from_source=webtop_search&spm_id_from=333.1007&page={k}&o={offset}"
    print("第{}页".format(k))
    print("offset:{}".format(offset))
    print("baseurl:{}".format(baseurl))

    apiurl = f"https://api.bilibili.com/x/web-interface/search/type?__refresh__=true&_extra=&context=&page={k}&page_size=42&from_source=&from_spmid=333.337&platform=pc&highlight=1&single_column=0&keyword=%E5%BC%80%E8%BD%A6+%E7%AC%AC%E4%B8%80%E8%A7%86%E8%A7%92&category_id=&search_type=video&dynamic_offset={offset}&preload=true&com2co=true"
    ...
    for i,j in enumerate(url_list):
        ...
        try:
            ...
            with open('bili/' + video_name + '.mp4', mode='wb') as f:
